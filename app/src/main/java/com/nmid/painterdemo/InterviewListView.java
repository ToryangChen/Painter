...
public class InterviewListView extends ListView implements OnScrollListener {
    ...
    public InterviewListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
...
//        setCacheColorHint(android.R.color.black);
        ...
        mHeadView = (LinearLayout) mInflater.inflate(R.layout.interview_list, null);
...
//        mArrowImageView.setMinimumHeight(50);
    ...
    public void onRefreshComplete() {
        mState = DONE;
    //    mLastUpdatedTextView.setText("�Ѽ�����ɣ�" + new Date().toLocaleString());
